                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1">
                    ...
                    <input type="number" className="w-full rounded-lg px-3 py-2 text-sm outline-none" style={{ border: '1px solid #EDE8F5', color: '#1E1B4B' }}
                      value={payForm.amount} onChange={e => setPayForm(f => ({ ...f, amount: e.target.value }))} placeholder={`Max: ${Number(outstanding).toLocaleString('id-ID')}`} max={outstanding} min={1} required />
                  </div>
                  <div className="flex flex-col gap-1">
                    ...
                    <select className="w-full rounded-lg px-3 py-2 text-sm outline-none" style={{ border: '1px solid #EDE8F5', color: '#1E1B4B' }}
                      ...
                      {['transfer', 'tunai', 'cek', 'giro', 'kartu'].map(m => <option key={m} value={m}>{m}</option>)}
                    </select>
                  </div>
                  <div className="flex flex-col gap-1">
